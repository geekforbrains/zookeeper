...
/**
 * Return an Evernote note objects contents converted from ENML to HTML.
 */
Note.prototype.toHtml = function(note, formatters, done) {
  parsers.html(note, formatters, done);
}


/**
 * Return an Evernote note objects contents converted from ENML to Markdown.
 */
Note.prototype.toMarkdown = function(note, formatters, done) {
  parsers.markdown(note, formatters, done);
}
